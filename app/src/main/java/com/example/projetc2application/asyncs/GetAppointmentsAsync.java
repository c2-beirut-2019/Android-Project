...
public class GetAppointmentsAsync extends AsyncTask<Void, Void, String> {
...
//    ProgressBar pgloadmore;
    ...
    public GetAppointmentsAsync(Activity activity, RelativeLayout rlProgressBar, boolean isRefresh, OnFinishListener listener) {
    ...
    protected String doInBackground(Void... params) {
        ...
        if (!didFail) {
            try {
                ...
                bean = GlobalFunctions.Get_StreamHttp(GlobalVars.BASE_URL + GlobalVars.GET_APPOINTMENTS_DOCTOR_URL, headers, true);
