...
//    ProgressBar pgloadmore;
    ...
    public GetNewsAsync(Activity activity, RelativeLayout rlProgressBar, boolean isRefresh, OnFinishListener listener) {
    ...
    protected String doInBackground(Void... params) {
        ...
        if (!didFail) {
            try {
                ...
                bean = GlobalFunctions.Get_StreamHttp(GlobalVars.BASE_URL + GlobalVars.GET_NEWS_URL, headers, true);
