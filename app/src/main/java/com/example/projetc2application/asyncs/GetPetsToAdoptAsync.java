...
public class GetPetsToAdoptAsync extends AsyncTask<Void, Void, String> {

    Activity activity;
    OnFinishListener mListener;
    ArrayList<PetsBean> petsBeans;
...
//    ProgressBar pgloadmore;
    ...
    public GetPetsToAdoptAsync(Activity activity, RelativeLayout rlProgressBar, boolean isRefresh, OnFinishListener listener) {
    ...
    protected String doInBackground(Void... params) {
        ...
        if (!didFail) {
            try {
                ...
                bean = GlobalFunctions.Get_StreamHttp(GlobalVars.BASE_URL + GlobalVars.GET_PETS_TO_ADOPT_URL, headers, true);
