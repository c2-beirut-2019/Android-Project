...
public class GetPetsUserAsync extends AsyncTask<Void, Void, String> {
...
//    ProgressBar pgloadmore;
    ...
    public GetPetsUserAsync(Activity activity, RelativeLayout rlProgressBar, boolean isRefresh, OnFinishListener listener) {
