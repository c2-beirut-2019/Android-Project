...
public class GetProductsAsync extends AsyncTask<Void, Void, String> {
...
//    ProgressBar pgloadmore;
    ...
    public GetProductsAsync(Activity activity, RelativeLayout rlProgressBar, boolean isRefresh, OnFinishListener listener) {
    ...
    protected String doInBackground(Void... params) {
        ...
        if (!didFail) {
            try {
                ...
                bean = GlobalFunctions.Get_StreamHttp(GlobalVars.BASE_URL + GlobalVars.GET_PRODUCTS_URL, headers, true);
